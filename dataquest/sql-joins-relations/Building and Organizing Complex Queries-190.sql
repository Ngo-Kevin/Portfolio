...
WITH customer_usa_90_dollars AS
    (
        SELECT * FROM customer_usa
        INTERSECT
        SELECT * FROM customer_gt_90_dollars
...
FROM employee e
LEFT JOIN customer_usa_90_dollars c ON c.support_rep_id = e.employee_id
        ...
        (
            SELECT
                ...
                (
                    ...
                    WHERE ccp.country = cmp.country AND cmp.max_purchase = ccp.total_purchased
                ) customer_id
