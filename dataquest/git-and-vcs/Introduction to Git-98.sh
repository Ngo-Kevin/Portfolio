...
/home/dq/random_numbers$ echo 'if __name__ ==\"__main\":\nprint(\"10\")'>script.
...
/home/dq/random_numbers$ git config --global user.name "Kevin"
...
/home/dq/random_numbers$ git commit -m "Made the number random"
