...
rounded_predictions = numpy.round(((predictions+predictions2)/2))
print(roc_auc_score(test['high_income'],rounded_predictions))
...
combined = numpy.round((numpy.sum(predictions,axis=0)/len(predictions)))
print(roc_auc_score(test['high_income'],combined))
