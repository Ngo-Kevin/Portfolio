...
iteration_one_rmse = mean_squared_error(test_iteration_one['price'], test_iteration_one['predicted_price'])**(.5)
...
def train_and_validate(df, folds):
    ...
    for fold in folds:
        ...
        test['predicted_price'] = model.predict(test[['accommodates']])
        rmse= mean_squared_error(test['price'],test['predicted_price'])**(.5)
