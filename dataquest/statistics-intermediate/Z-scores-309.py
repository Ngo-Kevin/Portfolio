...
plt.axvline(houses['SalePrice'].std(ddof=0)+mean,color='Red',label='Standard deviation')
...
mean = houses['SalePrice'].mean()
st_devs_away=(220000-mean)/houses['SalePrice'].std(ddof=0)
